...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/09 00:04:49 by tatashir          #+#    #+#             */
/*   Updated: 2023/03/09 16:16:50 by tatashir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    init_window(t_solong *s)
{
    ...
    s->win = mlx_new_window(s->mlx, s->win_h, "./so_long");
    if (s->win == NULL)
        exit_error(ERROR_MLX);
}

void    init_element(t_solong *s)
{
